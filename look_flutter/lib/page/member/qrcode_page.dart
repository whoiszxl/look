...
import 'package:look_flutter/utils/qrcode_util.dart';
import 'package:look_flutter/widgets/base_scaffold.dart';
import 'package:look_flutter/widgets/my_app_bar.dart';
                  ...
                  child: Column(
                    children: <Widget>[
                      ...
                      const Padding(
                          ...
                          child: Text("用手机LOOK APP扫一扫二维码，加我为好友", style: TextStyle(fontSize: 14, color: ColorManager.grey, fontWeight: FontWeight.bold))
                      ),
